...
CREATE TABLE IF NOT EXISTS transactions (
    ...
    prefixe_dest_id     INTEGER UNSIGNED,
    operateur_envoyeur_id INTEGER UNSIGNED,
    operateur_recepteur_id INTEGER UNSIGNED,
    commission_autre    DECIMAL(15,2) DEFAULT 0,
    frais_retrait_dest  DECIMAL(15,2) DEFAULT 0,
    created_at          DATETIME,
    updated_at          DATETIME,
    FOREIGN KEY (type_operation_id) REFERENCES types_operation(id) ON DELETE CASCADE ON UPDATE CASCADE,
