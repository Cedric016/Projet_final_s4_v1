...
<head>
    ...
    <title>Shareo - Espace Client</title>
...
<body>
    <header class="top-header">
        ...
        <div class="header-right">
            ...
            <a href="<?= site_url('client/deconnecter') ?>" class="header-icon-btn" aria-label="Déconnexion" title="Déconnexion">
                <i class="fas fa-sign-out-alt"></i>
            </a>
            <div class="user-menu" tabindex="0" role="button" aria-label="Menu utilisateur">
                <div class="user-avatar"><?= strtoupper(substr(esc($client['nom'] ?? 'C'), 0, 1)) ?></div>
                <div class="user-info">
                    <span class="user-name"><?= esc($client['nom'] ?? 'Client') ?></span>
                    <span class="user-phone"><?= esc($client['telephone'] ?? '') ?></span>
                </div>
    ...
    <aside class="sidebar" id="sidebar" role="navigation" aria-label="Navigation client">
        <div class="sidebar-section">
            <div class="sidebar-title">Mon espace</div>
            <nav class="sidebar-nav">
                <a href="<?= site_url('client') ?>" class="<?= ($active ?? '') === 'client' ? 'active' : '' ?>">
                    <i class="fas fa-home"></i> Accueil
                </a>
                <a href="<?= site_url('client/operations') ?>" class="<?= ($active ?? '') === 'operations' ? 'active' : '' ?>">
                    <i class="fas fa-paper-plane"></i> Opérations
                </a>
                <a href="<?= site_url('client/historique') ?>" class="<?= ($active ?? '') === 'historique' ? 'active' : '' ?>">
                    <i class="fas fa-history"></i> Historique
                </a>
            </nav>
        </div>
        <div class="sidebar-section">
            <div class="sidebar-title">Autre</div>
            <nav class="sidebar-nav">
                <a href="<?= site_url('dashboard') ?>">
                    <i class="fas fa-desktop"></i> Espace opérateur
                </a>
            </nav>
        </div>
